...
function App() {
  ...
  const sendMessage = async (message) => {
    ...
    if (!token) {
      setChatHistory(prev => [...prev, {
        id: Date.now(),
        role: 'assistant',
        content: 'Please log in to continue. Redirecting to login…',
  ...
  return (
    <div className="min-h-screen bg-academic-50 flex flex-col">
      <Navbar onMenuClick={toggleSidebar} onLoginClick={() => navigate('/login')} onLogoutClick={handleLogout} username={username} />
