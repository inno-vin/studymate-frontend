        ...
        <form onSubmit={handleSubmit} className="flex items-end">
          <div className="flex-1 relative">
            <textarea
              ...
              className="input-field resize-none min-h-[44px] max-h-32 overflow-y-auto pr-12"
              rows={1}
              disabled={isLoading}
            />
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`absolute bottom-1.5 right-1.5 h-9 w-9 flex items-center justify-center rounded-md transition-all duration-200 ${
